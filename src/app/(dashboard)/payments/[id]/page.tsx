  ...
  return (
    <div>
      <PageHeader
        ...
        description={`${formatCurrency(payment.payment_amount)} · ${payment.payment_method.replace("_", " ")} · ${formatDate(payment.payment_date)}`}
        actions={
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <Row label="Amount" value={<span className="font-medium">{formatCurrency(payment.payment_amount)}</span>} />
